...
<body>
        ...
        <div class="row justify-content-center">
            ...
            while ($row1 = mysqli_fetch_assoc($veg)) {
                ...
                <div class="col-md-3 m-3 rounded">
                    ...
                    $row1['p_id'] .
                    '" class="px-3 btn btn-sm btn-primary">Edit</a>
                            <button onclick="del_pro(' .
                    $row1['p_id'] .
                    ')" class="px-3 btn btn-sm btn-primary">Delete</button>
                        </div>
                    </div>
                </div>';
            }
    ...
    <?php if (isset($_GET['id'])) {
        ...
        $edit_sql = mysqli_query(
            $conn,
            "SELECT * FROM product WHERE p_id = '$edit_id'"
        );
                ...
                <div class="modal-body">
                    <form action="function_db.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="pename" class="form-control" value="' .
            $row9['p_name'] .
            '" id="pename" placeholder="Product Name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="peprice" class="form-control" value="' .
            $row9['p_price'] .
            '" id="peprice" placeholder="Product Price" required>
                            </div>
                        </div>           
                        <div class="form-group row">
                            <label for="peavail" class="col-sm-4 col-form-label">Product Availability</label>
                            <div class="col-sm-8">
                                <input type="text" name="eavail" class="form-control" value="' .
            $row9['available'] .
            '" id="peavail" placeholder="availability in kg/L/bottle/tin" required>
                            </div>
                        </div>  
    ...
    <div class="footer-copyright bg-primary text-white text-center py-1">Copyright © 2020 Reserved by Sai Grocery Store</div>
</body>
